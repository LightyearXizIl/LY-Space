...
contextBridge.exposeInMainWorld("lySpaceDesktop", {
    ...
    getCanvasRecoveryCandidates: (projects) => ipcRenderer.invoke("lyspace:canvas-recovery-candidates", projects),
    recoverCanvasProjects: (current, recovered) => ipcRenderer.invoke("lyspace:canvas-recover", current, recovered),
