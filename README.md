<p align="center">
  <img src="desktop/renderer/public/logo.svg" width="96" alt="LY Space logo">
</p>
...
<p align="center">
  <a href="docs/content/docs/overview/quick-start.mdx">快速开始</a> · <a href="docs/content/docs/overview/features.mdx">功能介绍</a> · <a href="docs/content/docs/canvas/canvas-node-manual.mdx">画布节点操作手册</a> · <a href="docs/content/docs/canvas/canvas-shortcuts.mdx">画布快捷键</a> · <a href="CLA.md">贡献者协议</a> · <a href="SECURITY.md">漏洞提交</a> · <a href="docs/content/docs/progress/todo.mdx">待办事项</a>
</p>
...
- AI 创作：桌面渲染层直连你配置的 OpenAI 兼容接口，支持文生图、图生图、参考图编辑、文本问答、音频和视频生成。
- 画布助手：围绕选中节点和上游节点对话、生图，并把结果插回画布。
- 插件系统：支持通过 URL 动态安装 / 启用 / 更新 / 卸载远程节点插件，并提供 TypeScript SDK 自行开发画布节点插件。
- 自定义接口调用：可自定义生图 / 视频接口的调用方式，灵活适配各类中转站与自建服务。
- 提示词库：桌面渲染层直连多个 GitHub 开源项目，并缓存到 IndexedDB。
...
AI API Key、Base URL、画布、素材和生成记录默认保存在桌面应用本地。

### Windows 安装

从 [release](release/) 下载并运行 `LY Space Setup 0.0.2.exe`。
...
`canvas-agent/` 与 `plugins/infinite-canvas/` 仍作为独立历史归档保留在仓库中，但不再随桌面应用构建或安装。
